resource "aws_autoscaling_group" "dns_auto_scaling_group" {
  ...
  desired_capacity          = 2
  force_delete              = true
  placement_group           = aws_placement_group.dns_placement_group.id
  launch_configuration      = aws_launch_configuration.dns_launch_configuration.name
...
resource "aws_placement_group" "dns_placement_group" {
...
resource "aws_launch_configuration" "dns_launch_configuration" {
  image_id      = data.aws_ami.dns_server.id
